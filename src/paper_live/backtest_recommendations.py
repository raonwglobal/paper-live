...
from .execution import PaperOrderRequest, OrderSide, OrderType
...
class RecommendationBacktest:
    ...
    def run(self, candles: Sequence[OHLCV], recommendations: Sequence[dict[str, Any]], *, quantity: Decimal = Decimal("1")) -> BacktestResult:
        ...
        def strategy(i: int, history: Sequence[OHLCV]) -> PaperOrderRequest | None:
            ...
            if float(rec.get("score",0)) <= 0: return None
