...
def test_drive_snapshot_is_versioned_and_manifested(tmp_path: Path):
    ...
    rows = [{"symbol": "005930", "close": 100, "effective_date": "2026-08-28", "available_at": "2026-08-28T18:00:00+09:00"}]
...
def test_drive_rejects_missing_or_invalid_point_in_time_fields(tmp_path: Path):
    ...
    with pytest.raises(ValueError):
        agent.validate_row_timestamps([{"symbol": "AAPL", "effective_date": "2026-08-29", "available_at": "2026-08-28T00:00:00Z"}])


def test_recommendation_prevents_lookahead_and_ranks():
    agent = StockRecommendationAgent()
    rows = [
        {"symbol": "AAPL", "available_at": "2026-08-31T10:00:00Z", "fundamental_score": 90, "momentum_score": 80, "technical_score": 85, "value_score": 70, "quality_score": 90, "sentiment_score": 80, "risk_score": 75},
        {"symbol": "BAD", "available_at": "2026-09-01T10:00:00Z", "fundamental_score": 100},
        {"symbol": "MSFT", "available_at": "2026-08-31T10:00:00Z", "fundamental_score": 75, "momentum_score": 75, "technical_score": 75, "value_score": 75, "quality_score": 75, "sentiment_score": 75, "risk_score": 75},
    ]
