...
def row(available_at):
    return {"symbol":"005930","available_at":available_at,
            "fundamental_score":80,"momentum_score":70,"technical_score":70,
            "value_score":60,"quality_score":70,"sentiment_score":70,"risk_score":60}
